...
import { Search, Tercera, ProductosA, Linea, TituloCont, Negro, Image, Enter, Ali, Spali, Agroin, Agro, Divi, Tarjeta, Imagro, Texto, H4} from '../Styles/Home'
